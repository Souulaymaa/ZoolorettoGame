...
class ZoolorettoGameStateTest {
    ...
    private val barn = Enclosure(100, 100, 0, Pair(0,0), true)
    ...
    private val player1 = Player("Player 1", Difficulty.HUMAN, playerEnclosures, barn)
    private val player2 = Player("Player 2", Difficulty.HUMAN, playerEnclosures, barn)
