...
class PurchaseTileTest {
    ...
    fun testBasicPurchase() {
        ...
        playerAction.purchaseTile(player2, vendingStall, player1Enclosure)
        ...
        //player 2 buys panda
        playerAction.purchaseTile(player1, panda, player2Enclosure)
    ...
    fun testPurchaseWithOffspringInFullEnclosure() {
        ...
        playerAction.purchaseTile(player2, pandaF, player1Enclosure)
